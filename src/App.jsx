...
const App = () => {
  ...
  // Handle custom table submission
    ...
    <div className="min-h-screen w-full overflow-x-hidden bg-slate-50 text-slate-800 p-4 text-center box-border flex flex-col justify-center items-center mx-auto small-mobile:p-2 small-mobile:min-h-screen small-mobile:justify-center small-mobile:items-center">
      ...
      {!username ? (
        ...
        <div className="my-4 flex flex-col items-stretch w-full text-center max-w-4xl">
          ...
          <button className="bg-teal-600 text-white border-none rounded-lg px-4 py-2 text-sm cursor-pointer transition-all hover:bg-teal-700 hover:shadow-lg shadow-md mx-4 my-2" onClick={() => setShowScores(true)}>
            Bekijk Scorebord
          </button>
